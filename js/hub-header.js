/* ============================================================================
   ...
   controller = {
     ...
     setActions(items),         // module-level commands ("Import CSV",
                                // "Build export", ...). One quiet ACTIONS
                                // disclosure on the right of the control
                                // row; hidden when called with [] or never.
                                // items = [{ id, label, meta?, onClick }]
   ========================================================================= */
...
export function mountHubHeader(config) {
  ...
  // Lives at the right end of the control row; hidden until setActions()
  // is called with a non-empty list. Each app populates this AFTER auth,
  // same pattern as the gear cog.
...
const HUB_APPS = [
  ...
  { file: 'mortgage.html',  name: 'Mortgage',  tag: 'home loan' },
  { file: 'airbnb.html',    name: 'AirBnB',    tag: 'rental'  },
  { file: 'fx.html',        name: 'Exchange Rates', tag: 'currency' },
  { file: 'ledger.html',    name: 'Financials', tag: 'ledger' },
];
